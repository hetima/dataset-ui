...
from lib.irodori_tts.dataset import LatentTextDataset, TTSCollator
from lib.irodori_tts.duration import set_duration_has_speaker_feature
from lib.irodori_tts.lora import (
    LORA_METADATA_NAME,
    LORA_TARGET_PRESETS,
...
from lib.irodori_tts.model import (
...
from lib.irodori_tts.optim import build_optimizer, build_scheduler, current_lr
from lib.irodori_tts.progress import TrainProgress
from lib.irodori_tts.rf import (
    rf_interpolate,
    rf_velocity_target,
    sample_logit_normal_t,
    sample_stratified_logit_normal_t,
)
from lib.irodori_tts.speaker_inversion import (
...
def resolve_training_config(
    ...
    raw_argv: list[str],
    is_main_process: bool,
) -> tuple[ModelConfig, TrainConfig, Path | None, dict | None, dict | None, dict]:
